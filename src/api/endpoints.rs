...
/// 发送单聊消息
/// 
/// 频率限制: 6000 条消息/每分钟，按收件人数量计算条数，可调频
...
/// 发送超级群消息
/// 
/// 频率限制: 100 条/每秒，按目标群组数量计算条数；单个频道限 20 条/每秒，可调频
pub const MESSAGE_ULTRA_GROUP_PUBLISH: &str = "/message/ultragroup/publish.json";
/// 设置单群聊消息扩展
/// 
/// 频率限制: 100 次/每秒，其中群聊消息扩展最多 20 次，可调频
...
/// 发送推送
/// 
/// 频率限制: 2 次/每小时，3 次/每自然日（共享），可调频
pub const PUSH: &str = "/push.json";
/// 撤回全量用户落地通知
/// 
/// 频率限制: 2 次/每小时，3 次/每自然日
...
/// 
/// 频率限制: 100 次/每秒，可调频
pub const CHATROOM_QUERY: &str = "/chatroom/query.json";
/// 批量查询是否在聊天室中
/// 
/// 频率限制: 100 次/每秒，可调频
...
/// 
/// 频率限制: 100 次/每秒，可调频
pub const SENSITIVEWORD_ADD: &str = "/sensitiveword/add.json";
/// 批量添加消息敏感词
/// 
/// 频率限制: 100 次/每秒
pub const SENSITIVEWORD_BATCH_ADD: &str = "/sensitiveword/batch/add.json";
/// 移除消息敏感词
/// 
/// 频率限制: 100 次/每秒，可调频
pub const SENSITIVEWORD_DELETE: &str = "/sensitiveword/delete.json";
/// 批量移除消息敏感词
/// 
/// 频率限制: 100 次/每秒，可调频
pub const SENSITIVEWORD_BATCH_DELETE: &str = "/sensitiveword/batch/delete.json";
/// 查询消息敏感词
/// 
/// 频率限制: 100 次/每秒，可调频
pub const SENSITIVEWORD_LIST: &str = "/sensitiveword/list.json";
